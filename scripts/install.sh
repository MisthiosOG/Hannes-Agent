...
# Configuration
REPO_URL_SSH="git@github.com:MisthiosOG/Hannes-Agent.git"
REPO_URL_HTTPS="https://github.com/MisthiosOG/Hannes-Agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/MisthiosOG/Hannes-Agent/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
