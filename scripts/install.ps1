...
$RepoUrlSsh = "git@github.com:MisthiosOG/Hannes-Agent.git"
$RepoUrlHttps = "https://github.com/MisthiosOG/Hannes-Agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/MisthiosOG/Hannes-Agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/MisthiosOG/Hannes-Agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/MisthiosOG/Hannes-Agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/MisthiosOG/Hannes-Agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
