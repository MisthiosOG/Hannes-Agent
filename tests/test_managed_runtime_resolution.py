"""Guard: Hannes-owned subprocesses must not resolve managed runtimes by bare PATH.
...
# Directories that are not Hannes-owned subprocess code: plugins ship their own
...
def test_no_unreviewed_bare_managed_runtime_lookups():
    ...
    assert not unexpected, (
        "Bare PATH lookup for a Hannes-managed runtime.\n\n"
