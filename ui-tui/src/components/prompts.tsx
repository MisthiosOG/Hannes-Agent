...
// Thin divider that separates prompt sections (question → choices → hint)
// inside the left-rail box. Width = available cols minus rail + padding.
const divider = (cols: number, t: Theme) => (
  <Text color={t.color.border}>{'─'.repeat(Math.max(4, cols - 4))}</Text>
)
