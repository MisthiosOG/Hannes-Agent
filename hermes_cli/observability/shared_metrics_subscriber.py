"""Relay subscriber for the persisted Hannes shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Hannes counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Hannes shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
