...
# xAI's public API is OpenAI-compatible for the endpoints Hannes commonly
# uses. The Responses endpoint is included because Hannes' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Hannes-managed OAuth credentials."""
