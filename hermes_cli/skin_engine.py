"""Hannes skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Hannes itself) customize the
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hannes-Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⌘"              # Shown on exit
      response_label: " ⌘ Hannes "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Hannes-Agent"
...
- ``default`` — Classic Hannes gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Hannes default — mint green identity",
        # Dark-authored. Values match the TUI's DARK_SEEDS (theme.ts) so the
        # classic CLI and the TUI render the same Hannes mint.
        "colors": {
            "banner_border": "#2F855A",
            "banner_title": "#6EE7B7",
            ...
            "prompt": "#E6F4EC",
            "input_rule": "#2F855A",
            "response_border": "#6EE7B7",
            "status_bar_bg": "#151B18",
            "status_bar_text": "#C0C0C0",
            "status_bar_strong": "#6EE7B7",
            "status_bar_dim": "#4C8C6F",
            "status_bar_good": "#68D391",
            "status_bar_warn": "#FFD700",
            "status_bar_bad": "#FF8C00",
            "status_bar_critical": "#FF6B6B",
            "session_label": "#6EE7B7",
            "session_border": "#4C8C6F",
            "completion_menu_bg": "#151B18",
            "completion_menu_current_bg": "#2C3A32",
            "selection_bg": "#2F4438",
            "shell_dollar": "#4dabf7",
            "voice_status_bg": "#151B18",
        },
        # Light overlay (merged onto `colors`; dark mode renders the vivid
        # block above untouched). Mint ladder on white: hue kept, saturation
        # tamed, mid luminance so it reads on a light terminal.
        "light_colors": {
            "banner_title": "#0E8A5A",
            "banner_accent": "#0F7A4D",
            "banner_dim": "#2F855A",
            "banner_text": "#16241D",
            "ui_accent": "#0F7A4D",
            "ui_label": "#2F855A",
            ...
            "ui_warn": "#D97706",
            "prompt": "#16241D",
            "response_border": "#0E8A5A",
            "session_label": "#2F855A",
            "status_bar_text": "#6F6F6F",
            "status_bar_strong": "#0E8A5A",
            "status_bar_dim": "#4C8C6F",
            "status_bar_good": "#3D8B63",
            "status_bar_warn": "#867000",
            ...
            "completion_menu_current_bg": "#DCEFE6",
            "selection_bg": "#D4E4F7",
        ...
        "branding": {
            "agent_name": "Hannes-Agent",
            "welcome": "Welcome to Hannes-Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⌘",
            "response_label": " ⌘ Hannes ",
            "prompt_symbol": "❯",
...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "retro-quest": {
        "name": "retro-quest",
        "description": "Retro Quest — warm JRPG, plum + beige + purple",
        "colors": {
            "banner_border": "#6D2C2A",
            "banner_title": "#FFE9A8",
            "banner_accent": "#B0413E",
            "banner_dim": "#8A6A5A",
            "banner_text": "#F7EAD0",
            "ui_accent": "#B0413E",
            "ui_label": "#FFE9A8",
            ...
            "prompt": "#F7EAD0",
            "input_rule": "#6D2C2A",
            "response_border": "#FFE9A8",
            "status_bar_bg": "#3A1716",
            "status_bar_text": "#F7EAD0",
            "status_bar_strong": "#FFE9A8",
            "status_bar_dim": "#8A6A5A",
            "status_bar_good": "#AED581",
            "status_bar_warn": "#FFB74D",
            "status_bar_bad": "#FF7043",
            "status_bar_critical": "#EF5350",
            "session_label": "#FFE9A8",
            "session_border": "#6D2C2A",
            "completion_menu_bg": "#3A1716",
            "completion_menu_current_bg": "#5C2A28",
            "selection_bg": "#7A3A38",
            "shell_dollar": "#B0413E",
            "voice_status_bg": "#3A1716",
        },
        "spinner": {
            "waiting_faces": ["(⚔)", "(▲)", "(◇)", "(<>)", "(✦)"],
            "thinking_faces": ["(⚔)", "(▲)", "(◇)", "(⌁)", "(✦)"],
            "thinking_verbs": [
                "embarking on a quest", "consulting the tome", "sharpening the blade",
                "reading the map", "hunting for treasure", "talking to the elder",
            ],
            "wings": [
                ["⟪⚔", "⚔⟫"],
                ["⟪▲", "▲⟫"],
        ...
        "branding": {
            "agent_name": "Retro Quest",
            "welcome": "Welcome, adventurer! Type your message or /help for commands.",
            "goodbye": "Farewell, hero! ⚔",
            "response_label": " ⚔ Quest ",
            "prompt_symbol": "❯",
            "help_header": "(⚔) Available Commands",
        },
        "tool_prefix": "┊",
    ...
    "neon-run": {
        "name": "neon-run",
        "description": "Neon Run — dark cyberpunk, cyan + magenta",
        "colors": {
            "banner_border": "#00F0FF",
            "banner_title": "#FF2EC4",
            ...
            "prompt": "#D8FAFF",
            "input_rule": "#00F0FF",
            "response_border": "#FF2EC4",
            "status_bar_bg": "#0B0B12",
            "status_bar_text": "#D8FAFF",
            "status_bar_strong": "#00F0FF",
            "status_bar_dim": "#4A90D9",
            "status_bar_good": "#00E676",
            "status_bar_warn": "#FFD740",
            "status_bar_bad": "#FF3D81",
            "status_bar_critical": "#FF1744",
            "session_label": "#00F0FF",
            "session_border": "#2E2E3A",
            "completion_menu_bg": "#0B0B12",
            "completion_menu_current_bg": "#1A1A2E",
            "selection_bg": "#20204A",
            "shell_dollar": "#00F0FF",
            "voice_status_bg": "#0B0B12",
        },
        "spinner": {
            "waiting_faces": ["(▰▱▱)", "(▱▰▱)", "(▱▱▰)", "(<>)"],
            "thinking_faces": ["(▰▱▱)", "(▱▰▱)", "(▱▱▰)", "(⌁)"],
            "thinking_verbs": [
                "hacking in", "overriding protocols", "evading the grid",
                "compiling shaders", "syncing to net", "bypassing firewall",
            ],
            "wings": [
                ["⟪▰", "▰⟫"],
                ["⟪◤", "◢⟫"],
        ...
        "branding": {
            "agent_name": "Neon Run",
            "welcome": "Welcome to the grid. Type your message or /help for commands.",
    ...
    "willow-vale": {
        "name": "willow-vale",
        "description": "Willow Vale — storybook earthy, forest + beige + gold",
        "colors": {
            "banner_border": "#1D2F22",
            "banner_title": "#E9B949",
            "banner_accent": "#4A7C59",
            "banner_dim": "#6B8F71",
            "banner_text": "#F5E9D2",
            "ui_accent": "#4A7C59",
            "ui_label": "#E9B949",
            ...
            "prompt": "#F5E9D2",
            "input_rule": "#1D2F22",
            "response_border": "#E9B949",
            "status_bar_bg": "#1D2F22",
            "status_bar_text": "#F5E9D2",
            "status_bar_strong": "#E9B949",
            "status_bar_dim": "#8AA68F",
            "status_bar_good": "#AED581",
            "status_bar_warn": "#E9B949",
            "status_bar_bad": "#D8896A",
            "status_bar_critical": "#C44536",
            "session_label": "#E9B949",
            "session_border": "#4A7C59",
            "completion_menu_bg": "#1D2F22",
            "completion_menu_current_bg": "#2E4A35",
            "selection_bg": "#3D5C46",
            "shell_dollar": "#4A7C59",
            "voice_status_bg": "#1D2F22",
        },
        "spinner": {
            "waiting_faces": ["(🌿)", "(🦉)", "(◇)", "(<>)", "(🍂)"],
            "thinking_faces": ["(🌿)", "(🦉)", "(◇)", "(⌁)", "(🍂)"],
            "thinking_verbs": [
                "wandering the vale", "listening to the trees", "following the path",
                "reading the journal", "tending the garden", "watching the river",
            ],
            "wings": [
                ["⟪🌿", "🌿⟫"],
                ["⟪▲", "▲⟫"],
        ...
        "branding": {
            "agent_name": "Willow Vale",
            "welcome": "Welcome to the vale. Type your message or /help for commands.",
            "goodbye": "Until the next season. 🌿",
            "response_label": " 🌿 Vale ",
            "prompt_symbol": "❯",
            "help_header": "(🌿) Available Commands",
        },
