...
_VALID_API_MODES = {
    ...
    # instead of Hannes' tool dispatch. Gated behind config key
    ...
    *,
    ...
    if provider == "anthropic":
        ...
        if _is_azure_endpoint:
            ...
            # chain.  Accept both `key_env` (Hannes canonical — matches the
            # custom_providers field name) and `api_key_env` (documented in the
            # Azure Foundry guide and read by most Hannes-compatible importers).
