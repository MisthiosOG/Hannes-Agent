"""Offline, non-destructive recovery for a damaged Hannes session database.
    ...
    try:
        ...
        if before != after:
            raise SessionRecoverySafetyError(
                ...
                "Stop every Hannes process using this profile and retry. "
                ...
                "Hannes process even after the gateway is stopped. Run the "
