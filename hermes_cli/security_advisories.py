"""
Security advisory checker for Hannes-Agent.
...
run in environments where the rest of Hannes failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Hannes requires 3.10+ but defensive.
        return None
    try:
