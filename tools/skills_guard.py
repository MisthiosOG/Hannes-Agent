...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Hannes secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Hannes configuration files directly"),
...
# scan. `.skillignore` is the Hannes-native name; `.clawhubignore` is honored
