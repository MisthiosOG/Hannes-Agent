...
flow through here without code changes on the Hannes side — the only
...
def _sanitized_cua_env() -> Dict[str, str]:
    """Telemetry-policy env with Hannes provider secrets stripped.
...
def _build_identity(binary: str, report: Dict[str, Any]) -> Dict[str, Any]:
    """Hannes-side identity block comparing resolved binary vs health_report."""
