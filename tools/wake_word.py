"""Wake-word ("Hey Hannes") detection — hands-free session trigger.
...
wake word, Hannes opens a fresh session and captures voice via the existing
...
def silent_audio_hint(details: Dict[str, Any]) -> str:
    ...
    if sys.platform == "darwin":
        return (
            "Microphone delivers only silence. Grant the Hannes backend "
