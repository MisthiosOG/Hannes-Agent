#!/usr/bin/env python3
"""
SWE Runner with Hannes Trajectory Format

A runner that uses Hannes-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Hannes-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Hannes-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Hannes format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Hannes-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Hannes-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Hannes Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Hannes-Agent's built-in execution environments
    and outputs trajectories in Hannes-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Hannes trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Hannes trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Hannes trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Hannes Trajectory Format")
    print("=" * 60)
