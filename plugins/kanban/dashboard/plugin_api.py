...
def _active_profile_name() -> str:
    """Return the current Hannes profile name for notify-sub ownership."""
    try:
...
def model_options():
    ...
    dropdown can never offer a model/provider pair the rest of Hannes
...
def list_kanban_projects():
    """List first-class Hannes projects for board scoping.
