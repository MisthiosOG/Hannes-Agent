"""ntfy platform adapter (Hannes plugin).
...
``plugins/platforms/ntfy/``. The Hannes plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Hannes dependency",
