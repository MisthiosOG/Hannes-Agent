...
Credential storage mirrors every other Hannes channel:
...
# registers Hannes as its own client_id.
...
# Default name of the project Hannes provisions for the operator.
DEFAULT_PROJECT_NAME = "Hannes-Agent"
