...
def _is_allowed_bridge_path(url: str) -> bool:
    ...
    known Hannes media cache directory.
...
def check_whatsapp_requirements() -> bool:
    ...
    """
    # Prefer Hannes-managed Node/npm so Windows installs are not broken by a
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            if not _deps_fresh:
                ...
                # Hannes-managed portable Node before falling back to PATH.
