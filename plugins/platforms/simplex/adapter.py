"""SimpleX Chat platform adapter (Hannes plugin).
...
This adapter ships as a Hannes platform plugin under
``plugins/platforms/simplex/``. The Hannes plugin loader scans the
...
# Imported at module top because they're stdlib-only inside Hannes — no
