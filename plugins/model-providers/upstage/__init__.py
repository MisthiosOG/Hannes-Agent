...
# When the user hasn't picked a reasoning effort, Hannes passes
...
# ON at this effort — matching the "medium (default)" that Hannes' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Hannes' effort vocabulary onto Solar's accepted set via the
