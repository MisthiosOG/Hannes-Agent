...
request omits ``thinking``.  Hannes' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Hannes reasoning
...
(per Z.AI / BigModel docs).  Hannes' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Hannes reasoning effort onto GLM's native vocabulary.
