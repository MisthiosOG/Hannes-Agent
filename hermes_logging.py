"""Centralized logging setup for Hannes-Agent.
...
# essentially always in Hannes (TUI, gateway, ``hy_memory`` server, MCP
...
def setup_logging(
    *,
    ...
    """Configure the Hannes logging subsystem.
    ...
    *force* is ``True``.
    ...
    ----------
    hermes_home
        Override for the Hannes home directory.  Falls back to
...
# the module header): when several Hannes processes log to the same file, an
