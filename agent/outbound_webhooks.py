...
(``gateway/platforms/webhook.py``): inbound wakes Hannes when the world
changes; outbound tells the world when Hannes does something.
...
Headers::
    ...
    User-Agent:              Hannes-Agent-Outbound-Webhook
