...
def _detect_environment(env: str) -> bool:
    ...
    if env == "kanban":
        ...
        # The Hannes Docker image runs s6-overlay as PID 1 (/init). s6 plants
...
#   <root>/.hermes/skills/   — Hannes-native location
...
def is_external_skill_path(path) -> bool:
    ...
    ``skills.external_dirs`` are externally owned: Hannes can discover and view
...
def iter_skill_index_files(skills_dir: Path, filename: str):
    ...
    Excludes Hannes metadata, VCS, virtualenv/dependency, cache, and skill
