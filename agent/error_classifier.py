...
# ``data:`` field before Hannes receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Hannes persists a content-less
...
# Request parameters that Hannes sends on SOME routes only, paired with the
