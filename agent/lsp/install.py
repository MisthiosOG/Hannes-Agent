...
appropriate.  All installs go to a Hannes-owned bin staging dir,
...
def hermes_lsp_bin_dir() -> Path:
    """Return the Hannes-owned bin staging dir for LSP servers."""
...
def _install_npm(
    ...
    # PATH, so a bare which() misses the Node that Hannes installed and
