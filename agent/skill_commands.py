...
#
# When a user invokes a /skill (or /bundle), Hannes expands the turn into a
...
def _resolve_skill_commands_home() -> str:
    """Return the effective Hannes home the skill scan should be scoped to.
        ...
        for scan_dir in dirs_to_scan:
            ...
            for skill_md in _iter:
                ...
                try:
                    ...
                    # with a core Hannes slash command (name or alias). The
                    ...
                    if resolve_command(cmd_name) is not None:
                        logger.warning(
                            ...
                            "collides with a core Hannes command; skipping "
...
def get_skill_commands() -> Dict[str, Dict[str, Any]]:
    ...
    active profile's Hannes home changes (e.g. Desktop switching profiles
