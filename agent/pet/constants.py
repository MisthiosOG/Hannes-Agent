...
row taxonomy is inferred from the atlas shape so Hannes can render both legacy
...
class PetState(str, Enum):
    ...
    These are Hannes' activity state names. They are not always identical to the
...
# Canonical Hannes activity names -> accepted row-name aliases in descending
