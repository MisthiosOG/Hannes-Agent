...
def _create_openai_client(*, api_key: str, base_url: str, **kwargs: Any) -> Any:
    ...
    try:
        ...
        pass
    # Hannes owns auxiliary retry + provider/model fallback policy (the
    ...
    # Hannes sees a single failure (issue #54465). Disable SDK-internal retries
    # by default and let Hannes control the budget; explicit callers can still
    # override via kwargs.
...
def _compression_threshold_for_model(
    ...
    *,
    ...
    consumed before Hannes triggers summarization.  Higher values delay
...
_NVIDIA_NIM_CLOUD_HEADERS = {
    "X-BILLING-INVOKE-ORIGIN": "HannesAgent",
}
...
def _codex_cloudflare_headers(access_token: str) -> Dict[str, str]:
    ...
    """
    headers = {
        "User-Agent": "codex_cli_rs/0.0.0 (Hannes-Agent)",
...
class _CodexCompletionsAdapter:
    ...
    def create(self, **kwargs) -> Any:
        ...
        resp_kwargs: Dict[str, Any] = {
            # Strip the Hannes-side ``-900k`` large-context picker suffix —
...
class _AnthropicCompletionsAdapter:
    ...
    def create(self, **kwargs) -> Any:
        ...
        #   - ``_``-prefixed keys: private Hannes plumbing (_reasoning_config
...
def _read_codex_access_token() -> Optional[str]:
    """Read a valid, non-expired Codex OAuth access token from Hannes auth store.
...
def _try_main_fallback_chain(
    ...
    main fallback policy before dropping into Hannes' built-in discovery
...
def _to_async_client(sync_client, model: str, is_vision: bool = False):
    ...
    # See _create_openai_client: disable SDK-internal retries so Hannes owns
...
def _build_call_kwargs(
    ...
    # Anthropic Messages adapters translate Hannes reasoning into native
...
def _call_llm_impl(
    ...
    *,
    ...
    Args:
        ...
        reasoning_config: Optional Hannes reasoning config for direct model calls
