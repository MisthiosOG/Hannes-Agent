...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Hannes never re-renders parts of this string mid-
    ...
    # Coding posture (base Hannes, any interactive coding surface in a code
    ...
    # Active-profile hint — names the Hannes profile the agent is running
    ...
    if active_profile == "default":
        post_workspace_parts.append(
            "Active Hannes profile: default. Other profiles (if any) live "
        ...
        post_workspace_parts.append(
            f"Active Hannes profile: {active_profile}. This session reads "
    ...
    if not agent.skip_context_files:
        ...
        # (developing Hannes). Every other surface (desktop chat panel,
