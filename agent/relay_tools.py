"""Core NeMo Relay adapter for Hannes tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Hannes tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Hannes Relay tool execution cannot run on an active event-loop thread"
    )
