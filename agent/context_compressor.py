...
# re-accesses the compacted region. Hannes already persists every
...
def _build_recovery_footer(session_id: str, region_len: int) -> str:
    ...
    Hannes persists every pre-compaction message in state.db; session_search
...
class ContextCompressor(ContextEngine):
    ...
    def should_defer_preflight_to_real_usage(self, rough_tokens: int) -> bool:
        ...
        overestimates so Hannes compresses before a provider rejects the
