"""Coding-context awareness — base Hannes, every interactive surface.

When the user runs Hannes inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Hannes shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Hannes should operate in its coding posture right now."""
