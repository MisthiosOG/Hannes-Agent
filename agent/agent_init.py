...
def init_agent(
    ...
    # management API (the historical Hannes behavior) or left to LM Studio's
    ...
    # Lets an enterprise admin append to or replace Hannes' built-in
    ...
    if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH and not _allow_lmstudio_explicit_below_floor:
        raise ValueError(
            ...
            f"by Hannes-Agent.  Choose a model with at least "
    ...
    # Nous Hannes 3/4 are chat models, not tool-call-tuned. The interactive
    ...
    if not agent.quiet_mode and (agent.platform or "cli") != "cli":
        try:
            ...
            if _hermes_warn:
                _user_msg = (
                    "⚠ Nous Research Hannes 3 & 4 models are NOT agentic — they "
