...
# Hannes' own machine-authored openers. A compaction handoff or a resumed
...
def auto_title_session(
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Hannes process): %s",
            e,
        )
...
def _is_real_user_turn(message: Any) -> bool:
    ...
    Hannes persists a lot of machinery under ``role="user"`` — compaction
