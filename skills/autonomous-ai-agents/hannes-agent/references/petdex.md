...
the Hannes CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core Hannes dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; Hannes uses its own
