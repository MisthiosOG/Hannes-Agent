...
TOOLSETS = {
    ...
    # Coding posture (base Hannes — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full Hannes toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with Hannes via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with Hannes via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
