"""ACP session manager — maps ACP sessions to Hannes AIAgent instances.
...
def _translate_acp_cwd(cwd: str) -> str:
    """Translate Windows ACP cwd values when Hannes itself is running in WSL.
...
def _register_task_cwd(task_id: str, cwd: str) -> None:
    ...
    Zed can launch Hannes from a Windows workspace while the ACP process runs
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed Hannes-Agent."""
...
class SessionManager:
    """Thread-safe manager for ACP sessions backed by Hannes AIAgent instances.
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            agent_factory: Optional callable that creates an AIAgent-like object.
                           ...
                           using the current Hannes runtime provider configuration.
    ...
    def _make_agent(
        ...
        *,
        ...
        # editor/session cwd instead of the Hannes daemon's process cwd.
