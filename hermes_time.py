"""
Timezone-aware clock for Hannes.
...
Invalid timezone values log a warning and fall back safely — Hannes never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Hannes requires 3.9+)
